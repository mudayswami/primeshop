                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Add Lots</div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{url('bulk-add-lots')}}" enctype="multipart/form-data">
                                    <div class="row">
                                        @csrf
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <a class="form-control h3"
                                        href="{{url('storage/lot/lots_bulk_upload.xlsx')}}"><u><b>Demo File</b></u></a>
                                </div>
                            </div>
                        </div>
                    </div>
